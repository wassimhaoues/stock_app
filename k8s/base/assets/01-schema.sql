-- Schéma SQL StockPro — copie pour Kustomize (configMapGenerator).
-- Source canonique : infra/mysql-init/01-schema.sql (utilisée par Docker Compose).
-- Ces deux fichiers doivent rester identiques. Si le schéma change, mettre à jour les deux.
START TRANSACTION;
SET time_zone = "+01:00";
SET NAMES utf8mb4;
